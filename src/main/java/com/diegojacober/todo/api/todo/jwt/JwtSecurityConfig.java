package com.diegojacober.todo.api.todo.jwt;
...
public class JwtSecurityConfig {
    ...
    @Bean
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity, @Autowired HandlerMappingIntrospector introspector)
            throws Exception {
        return httpSecurity
